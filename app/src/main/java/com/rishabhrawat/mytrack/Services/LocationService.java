package com.rishabhrawat.mytrack.Services;
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if (location != null) {
                          ...
                          //  User user = ((UserClient)(getApplicationContext())).getUser();
                            ...
                            UserLocation userLocation = new UserLocation(geoPoint, null,FirebaseAuth.getInstance().getCurrentUser().getDisplayName());
                            saveUserLocation(userLocation);
                            saveLocationHistory(userLocation);
                        }
                    }
                },
